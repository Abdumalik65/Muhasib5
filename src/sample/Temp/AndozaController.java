...
public class AndozaController extends Application {
    ...
    public AndozaController() {
        connection = new MySqlDBGeneral(ServerType.LOCAL).getDbConnection();
        GetDbData.initData(connection);
        user = GetDbData.getUser(1);
        user.setTovarHisobi(9);
    }
    public AndozaController(Connection connection, User user) {
    ...
    private void initCenterPane() {
        ...
        initYakunlaButton();
        initTovarTable();
        centerPane.getChildren().addAll(tovarTableView, xaridniYakunlaButton);
    }
    ...
    private TovarBox initTovarBox() {
        ObservableList<Standart> tovarObservableList = tovarBoxRefresh();
    ...
    private ObservableList<Standart> tovarBoxRefresh() {
    ...
    private TreeItem<Butoq> getBarCodeTreeItem() {
        ...
        TextField barCodeTextField = butoq.getTextField();
