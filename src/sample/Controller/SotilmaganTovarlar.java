...
public class SotilmaganTovarlar extends Application {
    Stage stage;
    Scene scene;
    ...
    public SotilmaganTovarlar(Connection connection, User user) {
    ...
    private ObservableList<HisobKitob> getTableData() {
        ...
        String select =
                "Select DISTINCT tovarHisobi from Kassa";
            ...
            try {
                while (rs.next()) {
                    ...
                    if (hisob != null) {
                        ...
                        hisob.setBalans(hisob.getBalans() - summa);
                    } else {
                        hisob = new Hisob(
                                tovar.getId(),
                                tovar.getText(),
