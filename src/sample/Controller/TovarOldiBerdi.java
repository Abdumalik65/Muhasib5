...
public class TovarOldiBerdi extends Application {
    Stage stage;
    Scene scene;
    ...
    public TovarOldiBerdi(Connection connection, User user) {
    ...
    private void initStage(Stage primaryStage) {
        ...
        stage.setTitle("Tovar xaridlarii");
