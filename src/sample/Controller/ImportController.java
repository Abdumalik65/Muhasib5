...
public class ImportController extends Application {
    Stage stage;
    Scene scene;
    ...
    public ImportController(Connection connection, User user) {
...
//        taftishHBox.setPadding(new Insets(padding));
        ObservableList<Standart> observableList = FXCollections.observableArrayList(
                ...
                new Standart(5, "Tovar qidir", null, null)
        );
    ...
    private Tugmachalar yangiTugmachalar() {
        ...
        add.setOnAction(event -> {
            ...
            qaydnomaData = containerController.display();
    ...
    private ObservableList<HisobKitob> malumotniYangila(QaydnomaData qaydnomaData) {
        ...
        balansHisobi(observableList, qaydnomaData.getChiqimId());
        tovarTableView.refresh();
    ...
    private Double balansHisobi(ObservableList<HisobKitob> observableList, Integer hisobId) {
        Double balance = 0d;
