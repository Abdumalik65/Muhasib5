...
public class PulOldiBerdi extends Application {
    Stage stage;
    Scene scene;
    ...
    public PulOldiBerdi(Connection connection, User user) {
    ...
    private void initCenterPane() {
        ...
        HBox hBox  = yangiJamiLabel();
        tovarTableView = yangiHisobKitobJadval();
        centerPane.getChildren().addAll(tovarTableView, textArea, hBox);
    }

    private HBox yangiJamiLabel() {
        HBox hBox = new HBox();
        Pane pane = new Pane();
        Pane pane1 = new Pane();
        ...
        jamiLabel = new Label();
        jamiLabel.setPadding(new Insets(padding));
        jamiLabel.setAlignment(Pos.CENTER);
        jamiLabel.setFont(jamiFont);
        hBox.getChildren().addAll(pane, jamiLabel, pane1);
        return hBox;
    }
...
//        taftishHBox.setPadding(new Insets(padding));
    ...
    private ObservableList<HisobKitob> malumotniYangila(QaydnomaData qaydnomaData) {
        ...
        jamiLabel.setText(decimalFormat.format(jami));
        textArea.setText(qaydnomaData.getIzoh());
