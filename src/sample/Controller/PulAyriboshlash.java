...
public class PulAyriboshlash extends Application {
    Stage stage;
    Scene scene;
    ...
    public PulAyriboshlash(Connection connection, User user) {
...
//            cell.setAlignment(Pos.CENTER);
    ...
    private GridPane gridPane() {
        ...
        ozgartir = ozgartirishTugmasi();
        ochir = ochirishTugmasi();
        ...
        gridPane.add(qulf, 3, 0, 1, 2);
        gridPane.add(ozgartir, 4, 0, 1, 2);
        gridPane.add(ochir, 5, 0, 1, 2);
    ...
    private void disable(Boolean disable) {
        ...
        ozgartir.setDisable(disable);
        ochir.setDisable(disable);
    ...
    private ObservableList<HisobKitob> amalniYukla(QaydnomaData qaydnomaData) {
        ...
        pulBox1.getTextField().setText("CHIQIM " + valuta1.getValuta());
        ...
        pulBox2.getTextField().setText("KIRIM " + valuta2.getValuta());
