...
public class EditableBigDecimalTableCell<S> extends TableCell<S, BigDecimal> {
    ...
    public void commitEdit(BigDecimal item) {
        if (isEditing()) {
            ...
            if (table != null) {
                TablePosition<S, BigDecimal> position = new TablePosition<S, BigDecimal>(getTableView(),
                        getTableRow().getIndex(), getTableColumn());
                TableColumn.CellEditEvent<S, BigDecimal> editEvent = new TableColumn.CellEditEvent<S, BigDecimal>(table, position,
