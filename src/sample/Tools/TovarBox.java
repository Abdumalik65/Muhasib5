...
public class TovarBox extends HBox {
    ...
    public TovarBox(Connection connection, User user) {
        this.connection = connection;
        this.user = user;
        ibtido();
    }

    public TovarBox(Connection connection, User user, Font font) {
        this.connection = connection;
        this.user = user;
        this.font = font;
        ibtido();
    ...
    public TovarBox(ObservableList<Standart> observableList, User user) {
        this.observableList = observableList;
        this.user = user;
        initHBox();
    }

    public TovarBox(ObservableList<Standart> observableList, User user, Font font) {
        this.observableList = observableList;
        this.user = user;
        this.font = font;
        initHBox();
