...
//                        setText(GetDbData.getTovar(item).getText());
    ...
    public TableColumn<QaydnomaData, DoubleTextBox> hisob1Hisob2Qaydnoma() {
        ...
        hisoblar.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<QaydnomaData, DoubleTextBox>, ObservableValue<DoubleTextBox>>() {
            ...
            public ObservableValue<DoubleTextBox> call(TableColumn.CellDataFeatures<QaydnomaData, DoubleTextBox> param) {
                ...
                Hisob hisob1= GetDbData.getHisob(qaydnomaData.getChiqimId());
                Hisob hisob2= GetDbData.getHisob(qaydnomaData.getKirimId());
    ...
    public TableColumn<QaydnomaData, DoubleTextBox> idHujjatQaydnoma() {
        TableColumn<QaydnomaData, DoubleTextBox> hisoblar = new TableColumn<>("ID/Hujjat");
        hisoblar.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<QaydnomaData, DoubleTextBox>, ObservableValue<DoubleTextBox>>() {

            @Override
            public ObservableValue<DoubleTextBox> call(TableColumn.CellDataFeatures<QaydnomaData, DoubleTextBox> param) {
                QaydnomaData qaydnomaData = param.getValue();
                Text text1 = new Text(qaydnomaData.getId().toString());
                text1.setFill(Color.GREEN);
                Text text2 = new Text(qaydnomaData.getHujjat().toString());
                text2.setFill(Color.BLUE);
                DoubleTextBox b = new DoubleTextBox(text1, text2);
                b.setAlignment(Pos.CENTER);
                b.setMaxWidth(2000);
    ...
    public TableColumn<HisobKitob, DoubleTextBox> amalHujjat() {
                ...
                protected void updateItem(Integer item, boolean empty) {
                    ...
                    if(empty) {
                        ...
                        if (tovar != null) {
                            ...
                            text.setStyle("-fx-text-alignment:justify;");
                            text.wrappingWidthProperty().bind(tovarColumn.widthProperty());
                            setGraphic(text);
                        } else {
                            setText("");
                        }
