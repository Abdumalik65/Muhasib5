...
public class ExportToExcel {
    ...
    public ExportToExcel(User user, QaydnomaData qaydnomaData, ObservableList<HisobKitob> hisobKitobObservableList) {
        this.user = user;
...
/*********** Ma`lumotlar jadvali ****************/
    ...
    private void dataBalanceCell(int hisobId, HisobKitob h, int rowIndex, int cellIndex) {
        ...
        if (rowIndex < 3) {
            ...
            formula = "E" + rowIndex + " + D" + (rowIndex + 1);
        }
        cell.setCellFormula(formula);
    }
    ...
    public void savdoChiptasi(QaydnomaData qaydnomaData, Connection connection, User user) {
        ...
        for (HisobKitob hk: hisobKitobObservableList) {
            if (hk.getDona()+hk.getNarh()!=0d) {
                if (hk.getAmal().equals(4) && hk.getHisob2().equals(qaydnomaData.getKirimId())) {
                    rowIndex++;
                    row = sheet.createRow(rowIndex);
        ...
        for (HisobKitob hk: hisobKitobObservableList) {
            switch (hk.getAmal()) {
                case 7: //tolov
                    ...
                    cellIndex = 0;
                    dataTextCell("To'lov " + valuta.getValuta(), rowIndex, cellIndex);
                ...
                case 8: //qaytim
                    ...
                    valuta = GetDbData.getValuta(hk.getValuta());
                    cellIndex = 0;
                    dataTextCell("Qaytim " + valuta.getValuta(), rowIndex, cellIndex);
                ...
                case 13: // Chegirma
                    ...
                    valuta = GetDbData.getValuta(hk.getValuta());
                    cellIndex = 0;
                    dataTextCell("Chegirma " + valuta.getValuta(), rowIndex, cellIndex);
                ...
                case 15: //bank tolovi
                    ...
                    valuta = GetDbData.getValuta(hk.getValuta());
                    cellIndex = 0;
                    dataTextCell("Plastik " + valuta.getValuta(), rowIndex, cellIndex);
...
*/
    ...
    private void jamiCell(String text, Double summa, int rowIndex) {
        ...
        CreationHelper creationHelper = wb.getCreationHelper();
        centerStyle.setDataFormat(creationHelper.createDataFormat().getFormat("#,##0.00"));
