...
public class BarCodeExcel {
    ...
    public BarCodeExcel(String printerim) {
    ...
    public void hisob(Integer hisobId, ObservableList<HisobKitob> hk) {
        ...
        cellIndex++;
        header2BarCodeCell(rowIndex, cellIndex);
        ...
        for (HisobKitob h: hk) {
            ...
            cellIndex++;
            dataBarCodeCell(hisobId, h, rowIndex, cellIndex);
    ...
    private void headerBalanceCell(int rowIndex, int cellIndex, Sheet sheet, ObservableList<HisobKitob> hk) {
        ...
        CellRangeAddress region2 = new CellRangeAddress(rowIndex, rowIndex, cellIndex,4);
        sheet.addMergedRegion(region2);
        cell.setCellStyle(headerNumericStyle);
        String formula = "SUM(D2:D5000)";
    ...
    private void header2BarCodeCell(int rowIndex, int cellIndex) {
        Cell cell = row.createCell(cellIndex, CellType.STRING);
    ...
    private void dataBarCodeCell(int hisobId, HisobKitob h, int rowIndex, int cellIndex) {
        Cell cell = row.createCell(cellIndex, CellType.STRING);
        if (h.getDona()<0) {
        ...
        cell.setCellValue(h.getBarCode());
    }
