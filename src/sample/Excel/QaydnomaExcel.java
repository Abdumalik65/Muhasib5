...
public class QaydnomaExcel {
    ...
    private void initFonts() {
        ...
        chiqimFont.setFontHeightInPoints((short)fontSize);
...
/*
        cellIndex ++;
        header2HisobNomiCell(rowIndex, cellIndex);

        cellIndex++;
        header2AmalCell(rowIndex, cellIndex);
*/
...
/*
            cellIndex ++;
            dataHisobCell(hisobId, h, rowIndex, cellIndex);

            cellIndex++;
            dataAmalCell(hisobId, h, rowIndex, cellIndex);
*/
    ...
    private void  headerSanaCell(int rowIndex, int cellIndex, Sheet sheet) {
        Cell cell = row.createCell(cellIndex);
        CellRangeAddress region2 = new CellRangeAddress(rowIndex, rowIndex, cellIndex,7);
...
*/
    ...
    private void header1Row(int rowIndex, Sheet sheet, QaydnomaData qaydnomaData, User user) {
        ...
        cell.setCellValue("Telefon: " + user.getPhone() +" Telegram: t.me/best_perfumery " + "Sotuvchi: "+user.getIsm().trim() + " Sana: " + sanaFormat.format(qaydnomaData.getSana()).trim());
